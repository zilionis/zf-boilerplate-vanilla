...
class Jbfreelance_Plugin_Auth extends \Zend_Controller_Plugin_Abstract
{
    protected $_acl;
    protected $_auth;
    
    public function __construct(Jbfreelance_Acl $acl)
    {
        $this->_acl = $acl;
    ...
    {        
        ...
        if($this->isValidRequest($request))
        {
            ...
            }else if(!$this->_auth->hasIdentity() && !$this->_acl->isAllowed($role, $resource, $action)){
