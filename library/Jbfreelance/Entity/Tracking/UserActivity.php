<?php
namespace Jbfreelance\Entity\Tracking;
use \Doctrine\Common\Collections\ArrayCollection as ArrayCollection;

/**
 * @Entity(repositoryClass="Jbfreelance\Repository\Tracking\UserActivity")
...
class UserActivity
{
     ...
     * 
     * @OneToMany(targetEntity="Jbfreelance\Entity\Tracking\Param", mappedBy="_activity", cascade={"persist", "remove"})
     */
    private $_params;
